...
*Ces ASV partagés sont donc ne représentent donc pas une part importante de l'ensemble des communautés bactériennes. On voit toutefois qu'ils représentent presque 2 fois ce à quoi on s'attendrait si l'ensemble des ASVs avait la même abondance.*  
...
*Quand on regarde les 3 ASV communs les plus abondants, on remarque que ceux-ci sont moyennement abondants : ils ne figurent pas parmi les plus présents, mais ne font pas non plus partie de la biosphère rare.*  
