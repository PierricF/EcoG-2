...
scale_color_manual(values=c(col_boues, col_déjections, col_compost))
```
Les échantillons sont bien regroupés par type de prélèvement et les trois points sont très éloignés les uns des autres, comme on le retrouve sur la figure de l'article. Il y a donc très peu d'ASVs en commun entre les boues, les déjections, le compost. 
